...
const columns = [
    { headerName: "BookingID", field: "BookingID", flex: 1 },
    { headerName: "DateOfBooking", field: "DateOfBooking", flex: 1 },
    { headerName: "FromDate", field: "FromDate", flex: 1 },
    { headerName: "ToDate", field: "ToDate", flex: 1 },
    { headerName: "BikeAvailability", field: "BikeAvailability", flex: 1 },
    { headerName: "TokenAmount", field: "TokenAmount", flex: 1 },
];
...
const Component = (props) => {
    ...
    const FetchResults = async () => {
        ...
        await Api.GetBookingsMulti(query, "")
            .then(async (res) => {
                if (res.status) {
                    _rows = res.values || [];
                    if (_rows.length > 0) {

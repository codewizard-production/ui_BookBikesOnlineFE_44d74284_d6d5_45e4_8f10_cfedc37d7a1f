...
const columns = [
    { headerName: "BikeID", field: "BikeID", flex: 1 },
    { headerName: "Manufacturer", field: "Manufacturer", flex: 1 },
    { headerName: "Model", field: "Model", flex: 1 },
    { headerName: "YearOfRegistration", field: "YearOfRegistration", flex: 1 },
    ...
    return (
        ...
        <>
            <Container {...props}>
                ...
                <Box style={{ width: '100%' }}>
                    <DataTable keyId={'BikeID'} columns={columns} rowsCount={rowsCount} rows={rows} sortBy={sortBy} pageInfo={pageInfo} onActionClicked={OnActionClicked}
